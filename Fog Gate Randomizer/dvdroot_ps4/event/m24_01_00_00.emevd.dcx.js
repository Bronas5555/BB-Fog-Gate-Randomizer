...
L2:
    ...
    $InitializeEvent(0, 92414100);
    $InitializeEvent(0, 92414110);
    $InitializeEvent(0, 92414111);
});
...
$Event(92414110, Default, function() {
    WaitFor(ActionButtonInArea(2410041, 2411810));
    DisplayBanner(TextBannerType.DemonKilled);
    WarpPlayer(24, 1, 2490998);
});

$Event(92414111, Default, function() {
    WaitFor(ActionButtonInArea(2410041, 2491810));
    DisplayBanner(TextBannerType.DemonKilled);
});
