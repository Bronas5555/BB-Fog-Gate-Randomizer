...
L2:
    ...
    $InitializeEvent(0, 9480, 0, 0, 0, 0);
    $InitializeEvent(1, 9480, 0, 0, 0, 0);
    $InitializeEvent(2, 9480, 0, 0, 0, 0);
    $InitializeEvent(3, 9480, 13501900, 13501900, 13501900, 6001);
    $InitializeEvent(4, 9480, 0, 0, 0, 0);
    $InitializeEvent(5, 9480, 13400970, 13400970, 13400970, 6001);
    $InitializeEvent(6, 9480, 13400971, 13400971, 13400971, 6001);
    $InitializeEvent(7, 9480, 13501901, 13501901, 13501901, 6001);
    $InitializeEvent(8, 9480, 13501902, 13501902, 13501902, 6001);
    $InitializeEvent(9, 9480, 13501903, 13501903, 13501903, 6001);
    $InitializeEvent(10, 9480, 13501904, 13501904, 13501904, 6001);
    if (!EventFlag(999)) {
...
$Event(3503, Default, function() {
    ...
    BatchSetEventFlags(12101100, 12101109, OFF);
});
...
$Event(7000, Default, function(chrEntityId, objEntityId, eventFlagId, eventFlagId2) {
    SetNetworkSyncState(Disabled);
...
$Event(9480, Default, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4) {
    EndIf(ThisEventSlot());
    EndIf(EventFlag(eventFlagId));
    EndIf(EventFlag(eventFlagId2));
    EndIf(EventFlag(eventFlagId3));
...
$Event(9720, Default, function() {
    if (!ThisEvent()) {
        WaitFor(
            (EventFlag(1362) && EventFlag(72400520) && PlayerInMap(21, 0))
                || EventFlag(1363)
